...
figure(1)
  ...
  title('X vs PRESSURE ROE EXPLICIT SCHEME','FontSize',18);
  ...
  legend({'ROE','Analytical'},'FontSize',14);
  xlabel('X','FontSize',18);
  title('X vs DENSITY ROE EXPLICIT SCHEME','FontSize',18)
  ...
  title('X vs VELOCITY ROE EXPLICIT SCHEME','FontSize',18)
  xt = get(gca, 'XTick');
  set(gca, 'FontSize', 16)
